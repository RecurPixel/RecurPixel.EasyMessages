...
**Warning:** **Contains sensitive data:** This preset includes user information, IP addresses, and full request details. Never use in production as it may violate privacy regulations (GDPR, CCPA, etc.).
