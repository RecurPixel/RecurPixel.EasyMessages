...
- ⚠️ Operation completed but with caveats
- ⚠️ Potential problem detected
- ⚠️ Typically logged at Warning level
...
| ⚠️ Update with no changes | Warning | `Msg.Crud.NoChangesDetected()` |
...
| ⚠️ File size near limit | Warning | `Msg.File.SizeWarning()` |
